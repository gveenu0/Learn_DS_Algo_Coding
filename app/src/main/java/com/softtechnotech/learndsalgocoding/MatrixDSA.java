...
public class MatrixDSA extends AppCompatActivity {
    ...
    private void init(){
        ...
        MatrixDSA.this.getLifecycle().addObserver(youTubePlayerView);
        ...
        youTubePlayerView.addYouTubePlayerListener(new AbstractYouTubePlayerListener() {
            ...
            public void onReady(@NonNull YouTubePlayer youTubePlayer) {
                ...
                listVideo.setOnItemClickListener((adapterView, view, i, l) -> {
                    ...
                    YouTubePlayerUtils.loadOrCueVideo(
                            youTubePlayer, MatrixDSA.this.getLifecycle(),
                            videoId, 0f
                    );
                });
    ...
    public ArrayList<String> getVideoInfo(int i) {
        ...
        try {
            InputStream XmlFileInputStream = getResources().openRawResource(R.raw.matrix);
    ...
    public void startYtFull(){
        ...
        intent.putExtra("className","MatrixDSA.java");
