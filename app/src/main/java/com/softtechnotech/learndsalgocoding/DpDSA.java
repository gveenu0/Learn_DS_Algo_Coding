...
public class DpDSA extends AppCompatActivity {
    ...
    private void init(){
        ...
        DpDSA.this.getLifecycle().addObserver(youTubePlayerView);
        ...
        youTubePlayerView.addYouTubePlayerListener(new AbstractYouTubePlayerListener() {
            ...
            public void onReady(@NonNull YouTubePlayer youTubePlayer) {
                ...
                listVideo.setOnItemClickListener((adapterView, view, i, l) -> {
                    ...
                    YouTubePlayerUtils.loadOrCueVideo(
                            youTubePlayer, DpDSA.this.getLifecycle(),
                            videoId, 0f
                    );
                });
    ...
    public ArrayList<String> getVideoInfo(int i) {
        ...
        try {
            InputStream XmlFileInputStream = getResources().openRawResource(R.raw.dp);
    ...
    public void startYtFull(){
        ...
        intent.putExtra("className","DpDSA.java");
