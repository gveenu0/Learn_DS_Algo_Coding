...
public class MiscDSA extends AppCompatActivity {
    ...
    private void init(){
        ...
        MiscDSA.this.getLifecycle().addObserver(youTubePlayerView);
        ...
        youTubePlayerView.addYouTubePlayerListener(new AbstractYouTubePlayerListener() {
            ...
            public void onReady(@NonNull YouTubePlayer youTubePlayer) {
                ...
                listVideo.setOnItemClickListener((adapterView, view, i, l) -> {
                    ...
                    YouTubePlayerUtils.loadOrCueVideo(
                            youTubePlayer, MiscDSA.this.getLifecycle(),
                            videoId, 0f
                    );
                });
    ...
    public ArrayList<String> getVideoInfo(int i) {
        ...
        try {
            InputStream XmlFileInputStream = getResources().openRawResource(R.raw.miscellaneous);
    ...
    public void startYtFull(){
        ...
        intent.putExtra("className","MiscDSA.java");
